 ...
 const [ searchText, setSearchText ] = useState("");
  ...
  return (
    ...
    <div className="flex flex-col mt-52 items-center ">
      ...
      <input type="text" className="text-black p-3 w-[500px] h-12 rounded-lg text-xl" onChange={(e) => setRegister(e.target.value)} onKeyDown={(e) => { if(e.key === 'Enter' && register !== "") router.push('/register/' + register) }} onMouseDown={() => setSearchText('Tryck på enter för att söka!')}  placeholder="Registrationsnummer" />
