    ...
    <>
      <div className='w-[800px] text-black rounded-2xl pb-20 bg-white mx-auto mt-20'>
          ...
          <div className='mx-52 mt-10 flex flex-col gap-2'>
            ...
            <input type="text" className='border-2 border-black rounded-xl p-2 w-96 text-xl' onChange={(e) => setModel(e.target.value)} placeholder='Model' />
            <input type="text" className='border-2 border-black rounded-xl p-2 w-96 text-xl' onChange={(e) => setYear(e.target.value)} placeholder='Årsmodell' />
            <input type="text" className='border-2 border-black rounded-xl p-2 w-96 text-xl' onChange={(e) => setColor(e.target.value)} placeholder='Färg' />
            <input type="text" className='border-2 border-black rounded-xl p-2 w-96 text-xl' onChange={(e) => setWheels(e.target.value)} placeholder='Antal Hjul' />
            <input type="text" className='border-2 border-black rounded-xl p-2 w-96 text-xl' onChange={(e) => setType(e.target.value)} placeholder='Typ' />
